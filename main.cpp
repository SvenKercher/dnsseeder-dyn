...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("45.77.86.242", 33300), true);
    db.Add(CService("45.77.69.239", 33300), true);
    db.Add(CService("45.76.76.71", 33300), true);
    db.Add(CService("108.61.216.214", 33300), true);
    db.Add(CService("108.61.224.148", 33300), true);
  }
  do {
